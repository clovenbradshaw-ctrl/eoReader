...
function renderLibrarianView() {
  ...
  sidebar.innerHTML = '<div style="padding:8px;">' +
    ...
    '<button class="act-btn" style="width:100%;font-size:10px;margin-top:8px;" onclick="switchToSummarizeView()"><i class="ph ph-chats-circle"></i> open chat with docs</button>' +
